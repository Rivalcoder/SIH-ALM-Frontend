    ...
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <Card className="w-full max-w-md glass-strong p-8 relative z-10 fade-in-up">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl font-bold mb-2">Join the Next Wave of Audio Intelligence</h1>
          <p className="text-muted-foreground">Build with us. Explore with us. Hear deeper.</p>
        </div>
